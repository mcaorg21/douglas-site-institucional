...
export function PracticeAreaParallaxRow({
  ...
  return (
    <>
      <div
        id={area.slug}
        className="scroll-mt-24 grid items-center gap-10 py-20 lg:grid-cols-2 lg:gap-16"
      >
        <motion.div
      ...
      {!isLast && (
        <div
          aria-hidden="true"
          className="relative left-1/2 h-6 w-screen -translate-x-1/2 bg-[url('/images/background_area.png')] bg-repeat opacity-40 [background-size:650px_auto]"
        />
      )}
    </>
  );
